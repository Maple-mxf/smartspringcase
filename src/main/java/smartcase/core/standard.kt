 ...
 *@since 1.0
 */
fun error(apiStandard: ApiStandard): ApiResponse = ApiResponse(status = apiStandard.status, code = apiStandard.code, message = apiStandard.message)

fun error(apiStandard: ApiStandard, message: String): ApiResponse = ApiResponse(status = apiStandard.status, code = apiStandard.code, message = message)